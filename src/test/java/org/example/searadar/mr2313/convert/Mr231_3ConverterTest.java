...
class Mr231_3ConverterTest {
    ...
    String ttm = "$RATTM,66,28.71,341.1,T,57.6,024.5,T,0.4,4.1,N,b,L,,457362,À*42";
    ...
    void messageTypeParsingTest() {
        ...
        assertInstanceOf(TrackedTargetMessage.class, messages.get(0));
        assertInstanceOf(InvalidMessage.class, messages.get(1));
        assertInstanceOf(RadarSystemDataMessage.class, messages.get(2));
    }
    ...
    void ttmConversionTest(){
        ...
        assertTrue(ttmMessage.getMsgRecTime().before(new Timestamp((System.currentTimeMillis()))));
    }
    ...
    void rsdConversionTest(){
        ...
        assertTrue(rsdMessage.getMsgRecTime().before(new Timestamp((System.currentTimeMillis()))));
    }
}